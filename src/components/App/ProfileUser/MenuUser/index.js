...
const MenuUser = () => (
  <div className="menu-user">
    <div className="menu-user__content">
      ...
      <NavLink to="/profil/mes-amis"><div className="menu-user__content-link"><UserPlus size={80} className="menu-user__content-link-icon"/><span className="menu-user__content-link-menu">Mes amis</span></div></NavLink>
